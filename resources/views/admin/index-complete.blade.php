    ...
    <div class="row">
      <div class="orderTable col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <ul class="nav nav-tabs">
          ...
          <li class="cancelled"><a href="index-cancelled.php">Cancelled <span>2</span></a></li>
          <li class="complete active"><a href="index-complete.php">Complete <span>2</span></a></li>
        </ul>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-success btn-sm btn-labeled" type="button" data-toggle="modal" data-target="#trackOrder">
                          <span class="btn-label">
                            <span class="icon icon-truck icon-lg icon-fw"></span>
                          </span>
                          Track Order
                        </button>
                      </td>
